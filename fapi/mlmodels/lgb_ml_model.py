...
class LgbMLModel(BaseMLModel):
    def create_model(
        self,
        model_path=Path("models/titanic_lgb_model.txt"),
    ...
    def preprocess(self, x):
        label_encoded = self._label_encode(self._pydantic_model_to_df(x)).to_numpy()
    ...
    def predict(self, x):
        ...
        return (self.model.predict(preprocessed_x) > self.threshold).astype(int)
